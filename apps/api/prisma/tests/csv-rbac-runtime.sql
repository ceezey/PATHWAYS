...
INSERT INTO pathways.projects(id,organization_id,code,title,created_by_id,program_id) VALUES
 (pg_temp.u(20),pg_temp.u(1),'RBAC_PROJECT','Synthetic project',pg_temp.u(104),NULL),
 (pg_temp.u(21),pg_temp.u(1),'RBAC_PROGRAM_PROJECT','Synthetic program project',pg_temp.u(104),pg_temp.u(10)),
 (pg_temp.u(22),pg_temp.u(2),'RBAC_FOREIGN','Synthetic foreign project',pg_temp.u(107),NULL);
...
BEGIN
 FOR n IN 1..6 LOOP
  ...
  END IF;
  IF n=1 THEN
   PERFORM pg_temp.assert_true((SELECT count(*)=1 FROM pathways.p09_enroll(pg_temp.u(21),pg_temp.u(30),'2026-01-02')),'Admin enrollment supporting helper');
   INSERT INTO pathways.user_project_assignments(organization_id,project_id,user_id,assigned_by_id)
