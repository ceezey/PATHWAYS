...
const genericResponse = passwordRecoveryAcknowledgement
        ...
        <Form {...form}>
          <form
            ...
            onSubmit={form.handleSubmit(async ({ email }) => {
              ...
              if (!isApprovedPasswordRecoveryOrigin(origin)) {
                window.location.replace(passwordRecoveryRequestUrl)
                return
              }
              const supabase = getBrowserSupabaseClient()
              if (supabase) {
                await requestPasswordRecoveryEmail(supabase.auth, email, origin)
              }
              setSubmitted(true)
            })}
          >
