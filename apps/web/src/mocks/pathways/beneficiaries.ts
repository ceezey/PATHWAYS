    ...
    notes: [
      {
        ...
        visibility: 'Internal',
        note: 'Accessibility accommodation confirmed in the record.',
      },
    ],
  },
  {
          ...
          ? [
              {
                ...
                note: 'Participation record generated from coded reference data.',
              },
            ]
          : [],
      assessments: [],
