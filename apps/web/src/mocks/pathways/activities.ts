import type { Activity } from '@/lib/demo-state/legacy-types'
...
export const mockActivities: Activity[] = [
  ...
  },
  {
    id: 'act-fm-proof-lab',
    projectId: 'futuremakers-ncr',
    title: 'Facilitate employer readiness clinic',
    description:
      'Deliver a test-ready employer readiness session and record attendance, narrative notes, and proof of conduct.',
    status: 'Planned',
